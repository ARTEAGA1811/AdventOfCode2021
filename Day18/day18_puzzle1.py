...
#Este es el ejercicio que hasta ahora más trabajo me ha costado, un dolor de cabeza pero
#valió la pena xD.
#como 4 horas solo debugueando para ver qué falla
...
def sumMyList(currSum:list, arr:list):
    ...
    # firstTup = explode(newSumArr)
    # newSumArr = firstTup[1]
    # print("hellodfdsf")
    # mytup = divide(newSumArr)
    # newSumArr = mytup[1]
    # #print(newSumArr)
    # while mytup[0]:
    #     firstTup = explode(newSumArr)
    #     newSumArr = firstTup[1]
    #     if firstTup[0]:
    #         print("Estoy dentro del bucl")
    #         mytup = divide(newSumArr)
    #         newSumArr = mytup[1]
    #     else:
    #         break
    #     # print("empieza dentro del bucle")
    #     # mytup = divide(newSumArr)
    #     # newSumArr = mytup[1]

    # tupleAux = explode(newSumArr)
    # newSumArr = tupleAux[1]
    # while True:
    #     tupleAuxTwo = divide(newSumArr)
    #     newSumArr = tupleAuxTwo[1]
    #     if tupleAuxTwo[0] == False:
    #         break
    #     else:
    #         tupleAux = explode(newSumArr)
    #         newSumArr = tupleAux[1]
